package com.outhub.kocrdemo.camera.view;
...
/**
 * Created by SummerRC on 2018/1/10.
 * description:
 */
...
public class MaskView extends AppCompatImageView {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        lineColor = a.getColor(R.styleable.cameView_MaskView_mask_view_line_color, DEFAULT_LINE_COLOR);
        lineStroke = a.getDimensionPixelOffset(R.styleable.cameView_MaskView_mask_view_line_stroke, DEFAULT_LINE_STROKE);
        lineAlpha = a.getInt(R.styleable.cameView_MaskView_mask_view_line_alpha, DEFAULT_LINE_ALPHA);
        areaBgColor = a.getColor(R.styleable.cameView_MaskView_mask_view_area_bg_color, DEFAULT_AREA_BG_COLOR);
        areaBgAlpha = a.getInt(R.styleable.cameView_MaskView_mask_view_area_bg_alpha, DEFAULT_AREA_BG_ALPHA);
